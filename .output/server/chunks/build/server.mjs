...
import { p as parseURL, e as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, l as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, i as createError$1, v as executeAsync, x as getHeader, y as setCookie, z as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "invite-token",
    path: "/invite/:token()",
    component: () => import('./_token_-DJmp4kC2.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-D-ga2XUq.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-qys50mg7.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DerDVRbE.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BCGuqgQY.mjs'));
